<div class="video-playlist-watch">
    <div class="video-playlist-watch-row row">
        ...
        <div class="col-sm-5 col-lg-4">
            <div class="hidden-xs">
                <h4 id="in-this-playlist-title">In This Playlist</h4>
            ...
            <div class="visible-xs">
                <h4 id="in-this-playlist-mobile-title">
        ...
        <div class="col-sm-5 col-lg-4">
            <div class="hidden-xs">
                <div class="video-extra other-videos">
                    <p>
                      <?=l('Create A New Playlist', 'playlist/'.$playlist->getUid().'/add', array('attributes' => array('class' => array('btn', 'btn-primary', 'btn-sm'))))?>
                      <?=l('See All Your Videos', 'your-videos', array('attributes' => array('class' => array('btn', 'btn-default', 'btn-sm'))))?>
                    </p>
                    <h4>Your Other Videos</h4>
                    <?= render($other_videos); ?>
                </div>
            </div>
            <div class="visible-xs">
