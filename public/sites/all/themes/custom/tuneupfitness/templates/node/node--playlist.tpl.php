...
<article
  ...
  <div class="col-xs-12">
    <hr />
    <?= render($content['field_middle_content']); ?>
    <hr />
    <div class="row">
      <div class="col-md-8">
        <?=render($content['field_bottom_content']);?>
      </div>
      <div class="col-md-4">
        <div class="panel panel-info">
          ...
          <div class="panel-body">
            <div class="add-to-cart-wrapper text-center clearfix">
              <?php print(render($content['sell_price'])); ?>
              <?php print(render($content['add_to_cart'])); ?>
            </div>
            <?php if(!empty($content['video_segments'])):?>
              <hr class="hr-text" data-content="OR">
              <p class="text-center text-uppercase"><small>Individual Sequences</small></p>
              <ul class="list-group">
                <?php foreach($content['video_segments']['nodes'] as $video_segment):?>
