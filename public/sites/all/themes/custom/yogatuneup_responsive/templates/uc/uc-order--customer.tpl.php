      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
            ...
            <p><b><?php print t('NEED TO TRACK YOUR ORDER?'); ?></b><br />
            <?php print t('Login Here: !login_link', array('!login_link' => $site_login_link)); ?>
            <br /><br />
            <?php print t('On your Dashboard click "Order History"'); ?><br />
            <?php print t('Click the order number and scroll down to see tracking info.'); ?>
            </p>
            <?php endif; ?>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              ...
              <tr>
                <td nowrap="nowrap">
                  <b><?php print t('PO Number:'); ?></b>
                </td>
                <td width="98%">
                  <?php print $order->field_po_num['und'][0]['value']; ?>
                </td>
              </tr>
              ...
              <tr>
                <td colspan="2">
                  ...
                  <table border="0" cellpadding="1" cellspacing="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                    ...
                    <tr>
                      <td nowrap="nowrap">
                        <b><?php print $order_total_title; ?>&nbsp;</b>
                      </td>
                      <td>
                        <b><?php print $order_total; ?></b>
                      </td>
                    </tr>
                      <?php if(!empty($order_total_suffix)):?>
                      <tr>
                          <td colspan="2">
                              <?=$order_total_suffix;?>
                          </td>
                        ...
                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                          ...
                          <tr>
                            ...
                            <td width="98%">
                              ...
                              <?php print $product->details; ?><br />
                              <?php print (strpos($product->model, 'OV-') === 0 || strpos($product->model, '-OV') === 1 || video_product_is_video($product->nid)) ? 'You can watch the above video after you '.l('login','user/login',array('absolute' => true)).' to your Yoga Tune Up account and go to your dashboard.' : ''?>
                            </td>
                          </tr>
                          <?php endforeach; ?>
                        </table>
                      ...
                      <tr>
                        <td colspan="2">
                          <div style="color:red;font-weight:bold;">
                            <?=_mm('checkout_review_backordered','',TRUE);?>
                          </div>
                        </td>
                      </tr>
                    <?php endif;?>
              ...
              <?php endif; ?>
              <?php if(_mm('email_footer_text','',TRUE)):?>
                <tr>
                  <td colspan="2">
                    <hr noshade="noshade" size="1" /><br />
                    <?=_mm('email_footer_text','',TRUE)?>
                  </td>
                </tr>
              <?php endif;?>
            </table>
