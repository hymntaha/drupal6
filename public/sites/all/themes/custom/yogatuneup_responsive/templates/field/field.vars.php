<?php
   ...
   function yogatuneup_responsive_preprocess_field(&$variables, $hook){
   ...
   function yogatuneup_responsive_preprocess_field_field_image(&$var, $hook){
   ...
   function yogatuneup_responsive_preprocess_field_field_title(&$var, $hook){
   ...
   function yogatuneup_responsive_preprocess_field_field_feature_image(&$var, $hook){
   ...
   function yogatuneup_responsive_preprocess_field_uc_product_image(&$var, $hook){
   ...
   function yogatuneup_responsive_preprocess_field_body(&$var, $hook){
