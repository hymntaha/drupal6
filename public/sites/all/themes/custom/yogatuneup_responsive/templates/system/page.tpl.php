...
<div class="container-fluid">
   <div class="navbar-header">
      <?php if ($logo): ?>
      <a class="logo visible-xs visible-sm" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
         <img id="_logo6" itemprop="logo" src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" />
      </a>
      <?php endif; ?>
...
<div class="container">
   ...
   <?php endif; ?>
   <?php if ($logo): ?>
   <a class="logo hidden-xs hidden-sm" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
      <img id="_logo6" itemprop="logo" src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" />
   </a>
   <?php if (!empty($breadcrumb)): print $breadcrumb; endif;?>
   <?php endif; ?>
   <div class="header-right pull-right"><?php print render($page['header']); ?></div>
</div>
...
<div>
   ...
   <div class="container-fluid above-content-container">
