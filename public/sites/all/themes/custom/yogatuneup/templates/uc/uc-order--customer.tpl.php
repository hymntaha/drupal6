                        ...
                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                          ...
                          <tr>
                            ...
                            <td width="98%">
                              ...
                              <?php print video_product_is_video($product->nid) ? 'You can watch the above video after you '.l('login','user/login',array('absolute' => true)).' to your Yoga Tune Up account and go to your dashboard.' : ''?>
                            </td>
                          </tr>
                          <?php endforeach; ?>
                        </table>
