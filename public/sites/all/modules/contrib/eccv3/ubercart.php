...
File last updated				: 06/27/2011
eCC Desktop Compitable Version 	: v3.0
eCC Mobile  Compitable Version 	: 1.3
Ubercart version 				: 6.x-2.0-rc2 to 7.x-3.0-beta3
===================================
*/
...
if(preg_match('/eCCMobile/',$_SERVER['HTTP_USER_AGENT']) || preg_match('/iPhone/',$_SERVER['HTTP_USER_AGENT']) || preg_match('/iPod/',$_SERVER['HTTP_USER_AGENT']) || $_REQUEST['apns'] === 'yes')  {
	require_once('lib/M.ubercart.php'); 
...
#information {
	...
	padding: 5px;
		...
		<div id="centerdiv">
		<div class="green_tr">Compatible with Ubercart version: <?php echo $cartCompitableVersion;?></div>
	...
	<div id="footer">
		...
		<?php
			...
			require_once('lib/D.ubercart.php'); 
