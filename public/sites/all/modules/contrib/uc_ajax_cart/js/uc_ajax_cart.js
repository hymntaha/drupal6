...
function ajaxCartFormSubmitted(e) {
  ...
  ajaxCartReloadCartView();
    ...
    if(e.indexOf('added to <a href="/cart">your shopping cart</a>') !== -1 || e.indexOf('Your item(s) have been updated') !== -1){
        jQuery(document).trigger('ubercart:addToCart', [jQuery(this)[0].data]);
    }
}
