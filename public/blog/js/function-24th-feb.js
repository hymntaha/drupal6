var check = document.location.href;	var arr = check.split('/');	check = arr[arr.length-2];
...
function addMoreFriend()
{
	...
	else
	{
	 ...
	 str += str1;
	str += '<div class="txtalign width200 pad_top10"><strong>Friend/Family '+ counterValue +':</strong></div>';
	str += '<div class="width315 padtb5">';
	str += '<table width="330" border="0" cellpadding="0" cellspacing="1">';
	str += '<tr>';
	str += '<td width="58" align="left">First Name:</td>';
	str += '<td width="98" align="left"><input name="friname[]" type="text" class="inputauto"  id="friname'+counterValue+'" size="13"/></td>';
	str += '<td width="29" align="right">Email:</td>';
	str += '<td width="140" align="left"><input type="text" name="email1[]"  id="email'+counterValue+'" class="inputauto" size="13"/></td>';
	str +='</tr>';
	
	str +='<tr><td colspan="4">&nbsp;</td></tr>';
	str +='<tr><td colspan="4">';
	str +='<input type="radio" name="videoreq'+counterValue+'" id="videoreq'+counterValue+'0" value="NK" align="absmiddle"checked="checked"/> NK &nbsp;';
	...
	str +='<input type="radio" name="videoreq'+counterValue+'" id="videoreq'+counterValue+'7" value="SR" align="absmiddle"/> SR &nbsp;';
	str +='</td></tr>';
	
	
	str +='</table>';
	str +='</div>';
	str +='<div style="padding-bottom:3px; padding-top:2px; padding-left:205px ; display:none" id="erremail'+counterValue+'">sdfgsd</div>';
	str +='</div>';
  ...
  str += '<input type="text" name="email1[]"  id="email'+counterValue+'" class="inputauto"  size="13"/></td>';
  str += '</tr>';
  str += '<tr>';
  str += '<td colspan="4" align="left"><input type="radio" name="videoreq'+counterValue+'" id="videoreq'+counterValue+'0" value="NK" align="absmiddle" checked="checked"/>NK &nbsp&nbsp;';
  str += '<input type="radio" name="videoreq'+counterValue+'"  id="videoreq'+counterValue+'1" value="SH" align="absmiddle"/>SH &nbsp;&nbsp;';
  str += '<input type="radio" name="videoreq'+counterValue+'" id="videoreq'+counterValue+'2" value="UB" align="absmiddle"/>UB &nbsp;&nbsp;';
  str += '<input type="radio" name="videoreq'+counterValue+'" id="videoreq'+counterValue+'3" value="LB" align="absmiddle"/>LB &nbsp;&nbsp;';
  str += '<input type="radio" name="videoreq'+counterValue+'" id="videoreq'+counterValue+'4" value="HP" align="absmiddle"/>HP &nbsp;&nbsp;';
